...
data class NaverOcrResult(
    ...
    override fun toDto() = OcrResultResponseDto(
                images[0].fields.first { it.name == "brandName" }.inferText,
                images[0].fields.first { it.name == "merchandiseName" }.inferText,
                images[0].fields.first { it.name == "expiredAt" }.inferText
    )
